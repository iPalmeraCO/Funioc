...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
		...
		register_sidebar( array(
		'name' => __( 'Info Footer', 'twentytwelve' ),
		'id' => 'sidebar-4',
		'description' => __( 'Información del footer', 'twentytwelve' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
		...
		register_sidebar( array(
		'name' => __( 'Redes Sociales Footer', 'twentytwelve' ),
		'id' => 'sidebar-5',
		'description' => __( 'Redes sociales del footer', 'twentytwelve' ),
